...
const tweenH = gsap.fromTo('h1', { opacity: 0 }, { duration: 1, opacity: 1 });
const tweenP = gsap.fromTo('p', { opacity: 0 }, { duration: 1, opacity: 1 });
const tweenB = gsap.fromTo('button', { opacity: 0 }, { duration: 1, opacity: 1 });
tl.add(tweenH)
  .add(tweenP)
  .add(tweenB);
